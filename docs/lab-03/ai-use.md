...
10. Implement Issue #37 IT Staff Ticket Queue using TDD, apply PR #48 review `5251567480` by making Owner choices independent of the current Ticket page, then correct the post-merge UI-test synchronization race by awaiting the asynchronous owner option and proving the correction with repeated isolated/full-suite runs before starting Issue #38.
