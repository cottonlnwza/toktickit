...
10. Verify Issue #39 with focused and full server/client regression, builds, Prisma validation, diff checking, and normal-development-database safety evidence before pushing the feature for peer review; report all command results as local verification unless hosted CI actually exists.
