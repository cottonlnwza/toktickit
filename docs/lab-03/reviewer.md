...
| #35 Authentication | `feature/lab3-3-authentication` | [PR #46](https://github.com/cottonlnwza/toktickit/pull/46) | Chartanat Upthaipiboon (`@Chxtamos`, `67070507210`); Tanboon Teawsawat (`@Tanaboonnnnn`, `67070507211`) | Reviews [`5247237227`](https://github.com/cottonlnwza/toktickit/pull/46#pullrequestreview-5247237227), [`5247342153`](https://github.com/cottonlnwza/toktickit/pull/46#pullrequestreview-5247342153), and [`5247449235`](https://github.com/cottonlnwza/toktickit/pull/46#pullrequestreview-5247449235) requested production password-gate evidence, concurrency-safe Change Password, and frozen BR-10 throttle-window semantics. Review [`5248249098`](https://github.com/cottonlnwza/toktickit/pull/46#pullrequestreview-5248249098) on `671336d` requested production Requester workflow continuity; that was corrected in `da51ccf`. Review [`5248526208`](https://github.com/cottonlnwza/toktickit/pull/46#pullrequestreview-5248526208) on exact HEAD `da51ccf` confirmed production continuity was fixed, then found the remaining Issue #35 blocker: the main Requester/Ticket/Attachment domain routes could still be called directly without a valid authenticated session. | Follow-up correction applies `requireNormalAccess` to all currently exported Requester/Ticket/Attachment and related reference-data routes while leaving requester ownership/role rewriting for Issue #36. API-08 proves all current protected route families reject direct unauthenticated access and proves a real Ticket-list route succeeds with a valid session but returns `401 AUTH_REQUIRED` after logout and after expiry. Client protected-domain requests send credentials. Lab 2 domain regression tests are adapted without claiming ownership authorization. Peer re-review remains pending. | Pending | Pending |
