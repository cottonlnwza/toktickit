...
| #36 Authorization and Requester Regression | `feature/lab3-4-authorization-requester-regression` | Pending | Pending | TDD red state recorded before implementation: the Issue #35 baseline still trusted/required legacy Requester identity in domain flows and lacked canonical ownership-safe Requester APIs, Public Comments, and Problem Appears Resolved. | Local implementation now passes the planned Issue #36 focused authorization/requester regression tests plus full server/client regression/build validation. No PR/review has occurred yet. | Pending | Pending |
