...
| API-14 | API | FR-10, BR-05; AC-10 | Problem Appears Resolved | Indication recorded; status unchanged; repeat safe/idempotent | `server/tests/lab-03/staff-ticket-detail.api.test.ts` | Pass — Issue #36 isolated PostgreSQL / Node 22 |
